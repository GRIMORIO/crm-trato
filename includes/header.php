...
$page_titles = [
    ...
    'analytics.php'    => 'Analítica del Embudo — Conversión y Velocidad',
...
<head>
    ...
    <title><?php echo htmlspecialchars($page_title); ?> · TIPS CRM</title>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            if (logo) {
                logo.src = (currentTheme === 'light') ? 'assets/image/log_azul.png' : 'assets/image/logo_blanco.png';
            }
        });
        ...
        function toggleCRMTheme() {
            ...
            const logo = document.querySelector('.sidebar-brand img');
            if (logo) {
                logo.src = (newTheme === 'light') ? 'assets/image/log_azul.png' : 'assets/image/logo_blanco.png';
            }
        }
    </script>
</head>
    ...
    <aside>
        <div class="sidebar-brand">
            <a href="panel.php" style="display: flex; align-items: center; gap: 0.6rem; width: 100%; justify-content: center;">
                <img src="assets/image/logo_blanco.png" alt="TIPS Logo" style="max-height: 40px; flex-shrink: 0; object-fit: contain;">
                <span style="color: var(--text-main); font-size: 1.1rem; font-weight: 700; letter-spacing: 0.02em; white-space: nowrap;">TIPS CRM</span>
            </a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-item">
                <a href="analytics.php" class="sidebar-link <?php echo $current_page == 'analytics.php' ? 'active' : ''; ?>">
                    ...
                    <span>Analítica del Embudo</span>
                </a>
            </li>
            <?php endif; ?>
            <li class="sidebar-item">
        ...
        <div class="sidebar-footer">
            ...
            <?php endif; ?>
            <p style="margin-top:0.5rem;">TIPS CRM v1.0</p>
        ...
        <div class="top-bar">
            ...
            <div class="page-title" style="display: flex; align-items: center;">
                ...
                if ($current_page == 'pipeline.php') {
                    ...
                    try {
                        ...
                        $pipelines = [['id' => 1, 'name' => 'Embudo de Ventas Principal']];
            ...
            <div class="top-bar-actions">
                <?php if ($current_page == 'pipeline.php'): ?>
                    ...
                    <button class="btn-action btn-secondary" onclick="openPipelineModal()" style="margin-right: 0.5rem; background:rgba(6,182,212,0.15); border-color:var(--color-primary); color: var(--color-primary);">
                        <i data-lucide="plus-square" style="color:var(--color-primary); display:inline-block; vertical-align:middle; margin-right:4px;"></i> Nuevo Embudo
                    </button>
                    ...
                    <button class="btn-action btn-secondary" onclick="deletePipeline(<?php echo $active_pipeline_id; ?>)" style="margin-right: 0.5rem; background:rgba(239,68,68,0.12); border-color:var(--color-error); color: var(--color-error);">
                        <i data-lucide="trash-2" style="color:var(--color-error); display:inline-block; vertical-align:middle; margin-right:4px;"></i> Suprimir Embudo
                    </button>
                    <?php endif; ?>
                    <button class="btn-action btn-secondary" onclick="openStageModal()" style="margin-right: 0.5rem; background:rgba(168,85,247,0.15); border-color:var(--color-secondary); color: var(--color-secondary);">
